...
public class HookUpDialog extends Dialog {
	...
	public HookUpDialog(final Context context) {
		...
		mTvAlertMessage.setTypeface(Togathor.getTfMyriadPro());

		mBtnOk = (Button) this.findViewById(R.id.btnOk);
		mBtnOk.setTypeface(Togathor.getTfMyriadProBold(), Typeface.BOLD);
		...
		mBtnCancel.setTypeface(Togathor.getTfMyriadProBold(), Typeface.BOLD);
