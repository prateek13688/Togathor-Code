package com.uf.togathor.utils.ble.ibeacon.service; /**
 * Radius Networks, Inc.
...
import com.uf.togathor.BuildConfig;
import com.uf.togathor.utils.ble.BluetoothCrashResolver;
import com.uf.togathor.utils.ble.ibeacon.IBeacon;
import com.uf.togathor.utils.ble.ibeacon.IBeaconManager;
import com.uf.togathor.utils.ble.ibeacon.Region;
            ...
            if (service != null) {
                switch (msg.what) {
                    case MSG_START_RANGING:
                        ...
                        service.startRangingBeaconsInRegion(startRMData.getRegionData(), new com.uf.togathor.utils.ble.ibeacon.service.Callback(startRMData.getCallbackPackageName()));
                    ...
                    case MSG_START_MONITORING:
                        ...
                        service.startMonitoringBeaconsInRegion(startRMData.getRegionData(), new com.uf.togathor.utils.ble.ibeacon.service.Callback(startRMData.getCallbackPackageName()));
                        service.setScanPeriods(startRMData.getScanPeriod(), startRMData.getBetweenScanPeriod());
                        break;
